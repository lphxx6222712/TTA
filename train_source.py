...
def train(args, train_loader, model, criterion, optimizer, epoch, print_freq=10):
    ...
    for i, (input, target,_,_) in enumerate(train_loader):
        ...
        loss = ce_loss + dice_loss + bce_loss
...
def parse_args():
    ...
    parser.add_argument('--device', default='Cirrus', type=str, help='Cirrus, Spectralis, Topcon')
    ...
    parser.add_argument('--loss', help='change model', default='NLL+dice+bce',#+bce+dice
                        type=str)
    ...
    parser.add_argument('--describe', default='no_dataset_norm_11.08v2test',#1group_norm_
